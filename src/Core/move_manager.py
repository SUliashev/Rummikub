...
class MoveManager:
    ...
    def chip_picked_up(self, grid_type: str, slot: tuple[int, int]) -> None:
        self.get_grid(grid_type)[slot] = None

        
    def multiple_chips_picked_up(self, grid_type: str, chip_positions: tuple[int, int]) -> None:
        for slot in chip_positions:
            self.get_grid(grid_type)[slot] = None
    

    def draw_one_chip(self) -> None:
    ...
    def place_multiple_chips_to(self, hovering_slots: list[tuple[int, int]], chips: list[Chip], origin_pos: tuple[str, list[tuple[int, int]]]) -> None:
        if hovering_slots:
            valid_move = True
    ...
    def move_single_chip_to(self, hovering_slot: tuple[int, int], chip: Chip, origin_pos: tuple[int, int]) -> None:
        valid_move = True
